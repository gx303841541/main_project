...
from backend.httprunner.__about__ import __description__, __version__
from backend.httprunner.api import HttpRunner
from backend.httprunner.compat import is_py2
from backend.httprunner.utils import (create_scaffold, get_python2_retire_msg,
...
def main_locust():
    ...
    try:
        from backend.httprunner import locusts
    except ImportError:
